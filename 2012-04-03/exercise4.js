...
COLOR([1,0.9,0.6])(floor3D);
COLOR([0.2,0.4,0.6])(piscine3D);
COLOR([0.9,0.8,0.6])(scala3D);
COLOR([0.4,0.4,0.4])(muri3D);
COLOR([0,0,0])(tetti3D);
COLOR([0,0,0])(colonne3D);
COLOR([0.8,0.8,0.8])(panchina3D);
COLOR([0.2,0.6,1])(vetrate3D);
//COLOR di tutte le struct

var generaSgabello = function(){
	var parteAlta = T([2])([0+0.5])(SIMPLEX_GRID([[1],[1],[0.05]]));
	var gamba1 = T([0,1])([0.2,0.45])(SIMPLEX_GRID([[0.1],[0.1],[0.5]]));
	var gamba2 = T([0,1])([0.7,0.45])(SIMPLEX_GRID([[0.1],[0.1],[0.5]]));
	return 	COLOR([1,0.1,0.1])(STRUCT([parteAlta,gamba2,gamba1]));
};
//permette di istanziare più sgabelli

var sgabello1 = T([0,1,2])([42,8,1])(generaSgabello());
var sgabello2 = T([0,1,2])([42,9,1])(generaSgabello());
var sgabello3 = T([0,1,2])([33,8,1])(generaSgabello());
var sgabello4 = T([0,1,2])([33,11,1])(generaSgabello());
var sgabello5 = T([0,1,2])([2,18,1])(generaSgabello());
var sgabello6 = T([0,1,2])([4,18,1])(generaSgabello());
var sgabello7 = T([0,1,2])([6,18,1])(generaSgabello());
var sgabelli3D = STRUCT([sgabello1,sgabello2,sgabello3,sgabello4,sgabello5,sgabello6,sgabello7]);

var pavilionFinale = STRUCT([floor3D, piscine3D, scala3D, muri3D, tetti3D, colonne3D, panchina3D, vetrate3D,sgabelli3D]);
DRAW(pavilionFinale);